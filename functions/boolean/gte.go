...
// Gte reports whether value is greater than or equal to than, comparing both as
// numbers so 5 and 5.0 rank the same. A non-numeric operand is an error, and nil
// counts as zero.
